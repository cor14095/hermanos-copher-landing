  ...
  return (
    <div className='bg-hc-blue grid grid-row-4'>
      <div className='flex flex-row pl-20 pr-20 pt-10 pb-10 gap-3'>
        <div className='m-auto text-slate-100 text-4xl'>
          <span>Ofertas</span>
        </div>
        <div className='h-1 grow m-auto bg-hc-red rounded-md' />
      </div>
      <div className='p-10 m-auto font-normal text-white'>
        <p className='tracking-widest text-xl'>Aprovecha nuestras promociones del mes</p>
      </div>
